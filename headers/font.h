//A header to import available fonts for rendering.
...
{
    //in the .cpp create a separate shader for the text stuff
...
struct font
{
    font(const char *fontPath)
    {
        ...
        {
            std::cout << "Error while initializing FreeType library. Exiting...\n";
            exit(EXIT_FAILURE);
        }
        //load font as face
        FT_Face face;
        ...
        {
            std::cout << "Font not found. Exiting...\n";
            exit(EXIT_FAILURE);
        }
        ...
        for (GLubyte c = 0; c < 128; c++)
        {
            ...
            {
                std::cout << "Failed to load current glyph. Proceeding to the next\n";
                continue;
            }
            //generate texture
